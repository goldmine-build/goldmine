...
// Close provides a mock function for the type Port
func (_mock *Port) Close() error {
	ret := _mock.Called()
...
// Flush provides a mock function for the type Port
func (_mock *Port) Flush() error {
	ret := _mock.Called()
...
func (_c *Port_Flush_Call) Return(err error) *Port_Flush_Call {
	_c.Call.Return(err)
	return _c
}
...
// Read provides a mock function for the type Port
func (_mock *Port) Read(b []byte) (int, error) {
	ret := _mock.Called(b)
...
func (_c *Port_Read_Call) RunAndReturn(run func(b []byte) (int, error)) *Port_Read_Call {
	_c.Call.Return(run)
	return _c
}

// Write provides a mock function for the type Port
func (_mock *Port) Write(b []byte) (int, error) {
	ret := _mock.Called(b)
...
func (_c *Port_Write_Call) RunAndReturn(run func(b []byte) (int, error)) *Port_Write_Call {
	_c.Call.Return(run)
	return _c
}
