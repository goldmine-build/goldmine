...
import (
	...
	allowlist "go.goldmine.build/npm-audit-mirror/go/allowlists"
	audit "go.goldmine.build/npm-audit-mirror/go/audits"
	"go.goldmine.build/npm-audit-mirror/go/checks"
	"go.goldmine.build/npm-audit-mirror/go/config"
	"go.goldmine.build/npm-audit-mirror/go/db"
	"go.goldmine.build/npm-audit-mirror/go/examiner"
	"go.goldmine.build/npm-audit-mirror/go/mirrors"
